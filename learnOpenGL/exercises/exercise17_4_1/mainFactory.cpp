...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        basicShader.use();
        //dirLight
        basicShader.setVec3("dirLight.ambient", 0.05f, 0.05f, 0.1f);
        basicShader.setVec3("dirLight.diffuse", 0.2f, 0.2f, 0.7);
        basicShader.setVec3("dirLight.specular", 0.7f, 0.7f, 0.7f);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            basicShader.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.09f);
            basicShader.setFloat("pointLights[" + std::to_string(i) + "].quadratic", 0.032f);
        }
        ...
        basicShader.setFloat("spotLight.outerCutOff", glm::cos(glm::radians(12.5f)));
        basicShader.setFloat("spotLight.constant", 1.0f);
        basicShader.setFloat("spotLight.linear", 0.009f);
        basicShader.setFloat("spotLight.quadratic", 0.0032f);
