...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        unsigned int transformLoc1 = glGetUniformLocation(ourShader.getID(), "transform");
        ...
        trans2 = glm::scale(trans2, glm::vec3(sinf((float)glfwGetTime()) / 2.0f + 0.5f, sinf((float)glfwGetTime()) / 2.0f + 0.5f, 0.0f));

        unsigned int transformLoc2 = glGetUniformLocation(ourShader.getID(), "transform");
